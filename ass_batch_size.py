...
#     opt = keras.optimizers.Adam(learning_rate=0.001)
    ...
    history = model.fit(x = X, y = y_one_hot, batch_size=16,epochs=400,shuffle = True, verbose=0,validation_split=0.2)
...
plt.xlabel("epochs")
plt.ylabel("val_loss")
plt.title("differrent activation function's val_loss")
plt.legend()
plt.show()
